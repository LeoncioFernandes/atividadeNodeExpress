...
class StudentsController {
  ...
  static findStudentById(req, res){
    ...
    const student = studs.find((student) => student.id == Number(id))
  ...
  static updateStudent(req, res){
    ...
    const studentIndex = studs.findIndex((student) => student.id == Number(id));
    ...
    res.status(200).json({student: studs[studentIndex]});
  }
  ...
  static deleteStudent(req, res){
    ...
    studs = studs.filter((student) => student.id != Number(id));
